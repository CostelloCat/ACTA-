...
_Last updated: 2026-09-20 (Claude, ACTA Relationship Engine preview at `/lab` shipped and then given a visual-strength pass per Ops follow-up — see PR #1 for detail)_
